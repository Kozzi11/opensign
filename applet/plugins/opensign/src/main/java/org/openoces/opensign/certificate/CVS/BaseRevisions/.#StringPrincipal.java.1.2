...
/* $Id: StringPrincipal.java,v 1.2 2012/02/28 08:21:22 pakj Exp $ */
...
/**
 * This interface class represents a simple string principal.
 *
...
public class StringPrincipal implements Principal {
    ...
    public StringPrincipal(String principal) {
