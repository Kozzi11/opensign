...
/* $Id: OpensignPasswordField.java,v 1.2 2012/02/28 08:20:48 pakj Exp $ */
...
public class OpensignPasswordField extends JPasswordField {
    private boolean pasteAllowed;

    public OpensignPasswordField(Font font) {
        super();
        setOpaque(true);
    ...
    public final void setAllowPaste(boolean allowed) {
