...
/* $Id: NanoXMLParser.java,v 1.2 2012/02/28 08:21:24 pakj Exp $ */
...
final public class NanoXMLParser
{
    ...
    */
	public NanoXMLParser() {
		...
		this.builder = new NanoXMLBuilder();
		this.validator = new NonValidator();
		this.reader = null;
		this.entityResolver = new XMLEntityResolver();
	}

	public NanoXMLParser(boolean parseHtml) {
    ...
    */
   public void setReader(NanoXMLReader reader)
   {
      this.reader = reader;
   }
    ...
    * @return the reader
    */
   public NanoXMLReader getReader()
   {
      return this.reader;
   }
   ...
   {
      try {
         builder.startBuilding(this.reader.getSystemID(),
      ...
      throws Exception
   {
      ...
      // DanID modification. We do not wish to resolve external entities.
//      if (systemID != null) {
...
//      }
      ...
      throws Exception
   {
      ...
      // Accept special HTML tag <META ... > that has no end tag </META>
      if(parseHtml){
			if ("META".equalsIgnoreCase(name) && prefix==null) {
