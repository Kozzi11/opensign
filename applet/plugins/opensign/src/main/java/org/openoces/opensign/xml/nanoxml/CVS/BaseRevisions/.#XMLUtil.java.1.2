...
/* $Id: XMLUtil.java,v 1.2 2012/02/28 08:21:25 pakj Exp $ */
...
final class XMLUtil {
    ...
    */
   static void skipComment(NanoXMLReader reader)
      throws IOException,
             XMLParseException
   {
      if (reader.read() != '-') {
    ...
    *		if an error occurred reading the data
    */
   static void skipTag(NanoXMLReader reader)
      throws IOException,
             XMLParseException
   {
      int level = 1;
    ...
    *		if an error occurred reading the data
    */
   static String scanSystemID(NanoXMLReader reader)
      throws IOException,
            XMLParseException
   {
    ...
    *		if an error occurred reading the data
    */
   static String scanIdentifier(NanoXMLReader reader)
      throws IOException,
             XMLParseException
   {
    ...
    *		if an error occurred reading the data
    */
   static String scanString(NanoXMLReader      reader,
                            char               entityChar,
    ...
    *		if an error occurred reading the data
    */
   static void skipWhitespace(NanoXMLReader   reader,
                              StringBuffer buffer)
      throws IOException
   {
      char ch;
    ...
    *		if an error occurred reading the data
    */
   static String read(NanoXMLReader      reader,
                      char               entityChar)
      throws IOException,
             XMLParseException
   {
    ...
    *                       an entity
    */
   static char readChar(NanoXMLReader reader,
                        char       entityChar)
      throws IOException,
             XMLParseException
   {
    ...
    *		if an error occurred reading the data
    */
   static boolean checkLiteral(NanoXMLReader      reader,
                               String             literal)
      throws IOException,
             XMLParseException
   {
