...
/* $Id: CopyableItem.java,v 1.4 2012/09/27 11:03:49 pakj Exp $ */
...
/**
 * This interface described a certificate that can be copied to a place selected by the user
 *
 * @author Preben Valeur  <prv@tdc.dk>
 * @author Paw F. Kjeldgaard <pakj@danid.dk>
 */
public interface CopyableItem {
