...
/* $Id: NanoXMLWriter.java,v 1.2 2012/02/28 08:21:24 pakj Exp $ */
 ...
 */
final public class NanoXMLWriter
{
      ...
      throws IOException
   {
      ...
      if (xml.getName() == null) {
         ...
         Iterator<String> en = xml.enumerateAttributeNames();
         ...
         if ((xml.getContent() != null)
            ...
            Iterator<XMLElement> children = xml.enumerateChildren();

            while (children.hasNext()) {
               XMLElement child = children.next();
               write(child, prettyPrint, indent + 4, collapseEmptyElements);
            }
