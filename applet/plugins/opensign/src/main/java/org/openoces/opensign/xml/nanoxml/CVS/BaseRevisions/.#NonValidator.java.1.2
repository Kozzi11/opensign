...
/* $Id: NonValidator.java,v 1.2 2012/02/28 08:21:24 pakj Exp $ */
   ...
   implements IXMLValidator
{
    ...
    * types.
    */
   protected Map attributeDefaultValues;
   ...
   public NonValidator()
   {
      this.attributeDefaultValues = new HashMap();
    ...
    *     If something went wrong.
    */
   protected void processElement(NanoXMLReader         reader,
                                 XMLEntityResolver entityResolver)
      throws Exception
   {
      String str = XMLUtil.read(reader, '%');
    ...
    *     If something went wrong.
    */
   protected void processConditionalSection(NanoXMLReader         reader,
                                            XMLEntityResolver entityResolver)
      throws Exception
   {
      XMLUtil.skipWhitespace(reader, null);
    ...
    *     If something went wrong.
    */
   protected void processIgnoreSection(NanoXMLReader         reader,
                                       XMLEntityResolver entityResolver)
      throws Exception
   {
    ...
    *     If something went wrong.
    */
   protected void processAttList(NanoXMLReader         reader,
                                 XMLEntityResolver entityResolver)
      throws Exception
   {
    ...
    *     If something went wrong.
    */
   protected void processEntity(NanoXMLReader         reader,
                                XMLEntityResolver entityResolver)
      throws Exception
   {
