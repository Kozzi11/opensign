...
public class RsaWithSha256Handler implements SignatureAlgorithmHandler{
    ...
    public String getSignature(CertificateHandler certificateHandler, String toBeSigned) throws IOException, GeneralSecurityException {
        ...
        sb.append("<ds:SignatureMethod Algorithm=\"http://www.w3.org/2001/04/xmldsig-more#rsa-sha256\"></ds:SignatureMethod>\n");
        sb.append("<ds:Reference URI=\"#ToBeSigned\">\n");
        sb.append("<ds:DigestMethod Algorithm=\"http://www.w3.org/2001/04/xmlenc#sha256\"></ds:DigestMethod>\n");
        sb.append("<ds:DigestValue>");
        sb.append(getDigestValueSha256(certificateHandler, toBeSigned));
        sb.append("</ds:DigestValue>\n");
    ...
    public String getAttachmentDigest(CertificateHandler certificateHandler, String attachmentObject) throws IOException, GeneralSecurityException {
        ...
        sb.append("<ds:DigestMethod Algorithm=\"http://www.w3.org/2001/04/xmlenc#sha256\"></ds:DigestMethod>\n");
        sb.append("<ds:DigestValue>");
        sb.append(getDigestValueSha256(certificateHandler, attachmentObject));
        sb.append("</ds:DigestValue>\n");
        return sb.toString();
    }
    ...
    private String getDigestValueSha256(CertificateHandler certificateHandler, String signText) throws IOException, GeneralSecurityException {
