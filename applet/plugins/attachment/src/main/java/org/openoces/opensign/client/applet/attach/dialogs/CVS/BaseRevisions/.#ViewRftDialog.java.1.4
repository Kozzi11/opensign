...
/* $Id: ViewRftDialog.java,v 1.4 2012/09/27 11:03:49 pakj Exp $ */
...
public class ViewRftDialog extends AbstractDialog {
    private PlainTextPanel panel;

    private String title;
    private byte[] data;

    public ViewRftDialog(AbstractDialog parent, final JComponent oldFocusComponent, String title, byte[] data) {
