...
/* $Id: RftPanel.java,v 1.4 2012/09/27 11:03:49 pakj Exp $ */
...
public class RftPanel extends AbstractViewPanel {

    public RftPanel(CallBackHandler callbackHandler, OpenSignDialog dialog, String title, byte[] data) {
