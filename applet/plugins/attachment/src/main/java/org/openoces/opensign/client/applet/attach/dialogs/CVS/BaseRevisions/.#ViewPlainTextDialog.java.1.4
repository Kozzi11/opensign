...
/* $Id: ViewPlainTextDialog.java,v 1.4 2012/09/27 11:03:49 pakj Exp $ */
...
public class ViewPlainTextDialog extends AbstractDialog {
    private PlainTextPanel panel;

    private String title;
    private byte[] data;

    public ViewPlainTextDialog(AbstractDialog parent, final JComponent oldFocusComponent, String title, byte[] data) {
    ...
    protected void initialize() {
        if(panel == null) panel = new PlainTextPanel(callBackHandler, this, title, data);
    }
