...
/* $Id: Checksum.java,v 1.2 2012/02/28 08:21:01 pakj Exp $ */

package org.openoces.opensign.client.applet.bootstrap;


/**
 * This interface class represents checsumming functionality
 *
...
interface Checksum {
    ...
    public void update(byte[] b, int offset, int count);
    public void digest();
}
