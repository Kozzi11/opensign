...
<h2><fmt:message key="openlogon.form.title"/></h2>

<form:form modelAttribute="openlogon" method="post" action="entrance_openlogon.html" >
                ...
                <tr>
                    ...
                    <td align="right">
                        <form:select path="optionalid">
                            ...
                            <form:option value="CUSTOMERID"><fmt:message key="form.applet.optional.id.customerid.label"/></form:option>
                            <form:option value="USERID"><fmt:message key="form.applet.optional.id.userid.label"/></form:option>
                        </form:select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="right">
                        <form:select path="signatureAlgorithm">
                            <form:option value="org.openoces.opensign.crypto.DefaultSignatureAlgorithm"><fmt:message key="form.applet.algorithm.method.default.label"/></form:option>
                            <form:option value="org.openoces.opensign.crypto.OcesSignatureAlgorithm"><fmt:message key="form.applet.algorithm.method.oces.label"/></form:option>
                            <form:option value="undefined"><fmt:message key="form.applet.algorithm.method.undefined.label"/></form:option>
                        </form:select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="right">
                        <form:select path="inputstyle">
                            <form:option value="default"><fmt:message key="form.applet.inputstyle.default.label"/></form:option>
                            <form:option value="virk"><fmt:message key="form.applet.inputstyle.virk.label"/></form:option>
                            <form:option value="ver_1.0"><fmt:message key="form.applet.inputstyle.ver_1.0.label"/></form:option>
                            <form:option value="not-specified"><fmt:message key="form.applet.inputstyle.not-specified.label"/></form:option>
                        </form:select>
                    </td>
                </tr>
                <tr>
